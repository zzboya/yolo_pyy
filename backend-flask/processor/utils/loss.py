...
from processor.utils.metrics import bbox_iou, box_iou, bbox_alpha_iou
from processor.utils.torch_utils import de_parallel, is_parallel
from processor.utils.general import xywh2xyxy
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = bbox_iou(pbox.T, tbox[i], x1y1x2y2=False, CIoU=True)  # iou(prediction, target)这里改IOU的类型
...
import math
from processor.utils.RepulsionLoss import repulsion_loss_torch
from processor.utils.general import Wasserstein
