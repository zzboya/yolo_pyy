...
# 数据集中的类别名(与标签数字相对应)
names = ['sugarcane','weed']  # class names
...
parser.add_argument('--model-path', type=str, default='./runs/train1/anchor/weights/last.pt', help='Path to the model')
parser.add_argument('--img-path', type=str, default='./caminput/02544.jpg', help='input image path')
parser.add_argument('--output-dir', type=str, default='./camout1/', help='output dir')
