...
from processor.models.yolox import DetectX, DetectYoloX
from processor.models.Detect.MuitlHead import Decoupled_Detect, ASFF_Detect, IDetect, IAuxDetect
from processor.utils.loss import ComputeLoss, ComputeNWDLoss, ComputeXLoss
...
from processor.models.common import *
from processor.models.experimental import *
from processor.utils.autoanchor import check_anchor_order
from processor.utils.general import LOGGER, check_version, check_yaml, make_divisible, print_args
from processor.utils.plots import feature_visualization
from processor.utils.torch_utils import fuse_conv_and_bn, initialize_weights, model_info, scale_img, select_device, time_sync
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        # yolov4, r
            ...
            c2 = ch[f] * 4
        elif m in [S2Attention, SimSPPF, ACmix, CrissCrossAttention, SOCA, ShuffleAttention, SEAttention, SKAttention]:  #注意力机制#
            c1, c2 = ch[f], args[0]
            if c2 != no:  # if not output
                c2 = make_divisible(c2 * gw, 8)
            args = [c1, *args[1:]]
        ...
        # 添加bifpn_add结构
        elif m in [BiFPN_Add2, BiFPN_Add3, BiFPN_Add6]:
