...
# 裁剪小图的路径
data_root = Path(f'./images_patch/ShiSheng01')
label_root=Path(r'E:\model\yoloair-main\yoloair-main\images_label\ShiSheng01\labelsvoc')
#label_root=Path(f'./images_patch_detect/ShiSheng01/labelsvoc')
tag = '\\'  # 路径分隔符
def custom_sort(x, y):
...
img = cv2.imread(str(f'./imagesbig/ShiSheng01.jpg'))
...
cv2.imwrite(f'./images_big/ShiSheng01/big_detect3.png',img)