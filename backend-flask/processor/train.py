...
from models.common import BiFPN_Add3, BiFPN_Add2, BiFPN_Add6
...
def parse_opt(known=False):
    ...
    #parser.add_argument('--cfg', type=str, default='configs/yolov7-Improved/yolov7_CA_BiFPN_CNEB.yaml', help='model.yaml path')
    parser.add_argument('--cfg', type=str, default='configs/yolov7/train/yolov7.yaml',help='model.yaml path')
    # parser.add_argument('--data', type=str, default=ROOT / 'data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/sugarcane.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--image-weights', action='store_true', help='use weighted image selection for training')    #trick
    ...
    parser.add_argument('--workers', type=int, default=0, help='max dataloader workers (per RANK in DDP mode)')      #liux设置为4
    ...
    parser.add_argument('--patience', type=int, default=100, help='EarlyStopping patience (epochs without improvement)')   #在default值轮数里没有提升，则停止训练模型
